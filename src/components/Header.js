        ...
        <nav className="header_gnavi">
          <ul className="header_gnavi_list">
            <li className="header_gnavi_list_item">
              <a className="link" href="https://timeless-kaitori.com/news/">お知らせ</a>
            </li>
            <li className="header_gnavi_list_item">
              <a className="link" href="https://timeless-kaitori.com/shop/">店舗一覧</a>
            </li>
            <li className="header_gnavi_list_item">
              <a className="link" href="https://timeless-kaitori.com/event/">催事一覧</a>
            </li>
            <li className="header_gnavi_list_item">
              ...
              <div className="accordion_menu" style={{ display: 'none' }}>
                ...
                <ul className="accordion_menu_list cf">
                  ...
                  <li className="accordion_menu_list_item">
                    <a className="link" href="https://timeless-kaitori.com/watch/">時計</a>
                  </li>
                  {/* ...以下省略... */}
                </ul>
              </div>
